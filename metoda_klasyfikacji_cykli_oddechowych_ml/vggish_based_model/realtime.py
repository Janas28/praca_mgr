...
fig.suptitle(f'Cycles: {CYCLE_COUNTER} Colours meaning: Red - Cycle, Blue - Silence')  # Instruction
...
def update_plot(frames, prediction, is_calibrating=False):
    ...
    if is_calibrating:
        ...
        fig.suptitle(
            f'Inhales: {CYCLE_COUNTER} Colours meaning: Red - Cycle, Blue - Silence')  # Instruction
